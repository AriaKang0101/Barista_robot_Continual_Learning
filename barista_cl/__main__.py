...
def main():
    ...
    scene_args(prep)
    prep.add_argument("--output", default="artifacts/tasks_v3.json")
    ...
    scene_args(preview)
    preview.add_argument("--tasks", default="artifacts/tasks_v3.json")
    ...
    scene_args(train)
    train.add_argument("--tasks", default="artifacts/tasks_v3.json")
