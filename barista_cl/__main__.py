...
def main():
    ...
    prep = commands.add_parser("prepare", help="Build reachable A/B/C tasks and stratified held-out starts")
    scene_args(prep)
    prep.add_argument("--output", default="artifacts/tasks_v4.json")
    prep.add_argument("--seed", type=int, default=2026)
    prep.add_argument("--grid-size", type=int, default=17)
    prep.add_argument("--tolerance", type=float, default=0.15,
                      help="Original PPO success tolerance (metres) for both controlled points")
    prep.add_argument("--clearance", type=float, default=0.01)
    prep.add_argument("--goal-clearance", type=float, default=0.03,
                      help="Extra obstacle clearance required at A/B/C targets")
    ...
    scene_args(preview)
    preview.add_argument("--tasks", default="artifacts/tasks_v4.json")
    ...
    scene_args(train)
    train.add_argument("--tasks", default="artifacts/tasks_v4.json")
